...
class Listing(crud_views.Listing):
    ...
    @view_config(
        context=ModelAdmin, name="listing", renderer="crud/listing.html", route_name="admin", permission="view"
    )
    def listing(self):
...
class Show(crud_views.Show):
    ...
    @view_config(
        context=ModelAdmin.Resource, name="show", renderer="crud/show.html", route_name="admin", permission="view"
    )
    def show(self):
        # We override this method just to define admin route_name traversing
...
class Edit(crud_views.Edit):
    ...
    @view_config(
        context=ModelAdmin.Resource, name="edit", renderer="crud/edit.html", route_name="admin", permission="edit"
    )
    def edit(self):
        # We override this method just to define admin route_name traversing
